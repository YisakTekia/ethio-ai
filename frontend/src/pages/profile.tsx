...
export default function Profile() {
  ...
  // States for dynamic database user
  ...
  // 1. Fetch real user data from Database on Mount (Fixes the refresh issue!)
  useEffect(() => {
    ...
    <div className="min-h-screen bg-slate-50 p-6 pb-24 relative">
      ...
      <div className="space-y-5 max-w-md mx-auto animate-fade-in-up">
        ...
        <div className="bg-white rounded-3xl p-2 shadow-sm border border-gray-100">
          ...
          <button onClick={() => showPopup("ለእገዛ በ 0900000000 መደወል ወይም በ Telegram @StarThinkSupport ማግኘት ይችላሉ።")} className="w-full flex items-center justify-between p-4 hover:bg-gray-50 rounded-2xl transition-colors active:scale-[0.98]">
            <div className="flex items-center gap-3">
