  ...
  return (
    <div className="flex flex-col gap-6 pb-24 animate-fade-in-up mt-2 bg-slate-50/30 min-h-screen">
      ...
      {/* 2. Gamified Daily Quiz Card -  */}
       <div className="px-4">
        <div className="relative overflow-hidden bg-linear-to-r from-purple-600 to-fuchsia-600 rounded-[24px] p-1 shadow-lg shadow-purple-200/50">
          <div className="bg-white rounded-[20px] p-5 relative overflow-hidden">
            ...
            <div className="relative z-10 flex items-start gap-4">
              <div className="w-12 h-12 rounded-2xl bg-linear-to-tr from-purple-100 to-fuchsia-100 flex items-center justify-center flex-shrink-0 shadow-inner">
      ...
      {dailyTip && (
        <div className="px-4">
          <div className="relative overflow-hidden bg-linear-to-br from-blue-600 to-indigo-700 rounded-3xl p-6 text-white shadow-lg shadow-blue-200/50 animate-fade-in-up">
      ...
      <div className="px-4 mt-2">
        ...
        <div className="grid gap-4">
          <Link to="/sports" className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4 hover:shadow-md active:scale-[0.98] transition-all group">
            <div className="w-14 h-14 rounded-2xl bg-orange-50 flex items-center justify-center shrink-0 group-hover:bg-orange-100"><Trophy className="w-7 h-7 text-orange-500" /></div>
          ...
          <Link to="/health" className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4 hover:shadow-md active:scale-[0.98] transition-all group">
            <div className="w-14 h-14 rounded-2xl bg-red-50 flex items-center justify-center shrink-0 group-hover:bg-red-100"><HeartPulse className="w-7 h-7 text-red-500" /></div>
          ...
          <Link to="/education" className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4 hover:shadow-md active:scale-[0.98] transition-all group">
            <div className="w-14 h-14 rounded-2xl bg-indigo-50 flex items-center justify-center shrink-0 group-hover:bg-indigo-100"><BookOpen className="w-7 h-7 text-indigo-600" /></div>
