...
export default function Quiz() {
  ...
  useEffect(() => {
    const fetchDailyQuiz = async () => {
      try {
        const response = await fetch('https://ethio-ai-api.onrender.com/api/auth/api/quiz/daily', {
  ...
  const handleSubmitQuiz = async (timeOut = false) => {
    ...
    try {
      const response = await fetch('https://ethio-ai-api.onrender.com/api/auth/api/quiz/submit', {
        method: 'POST',
        headers: { 
